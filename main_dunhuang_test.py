...
def parse_args():
    ...
    parser.add_argument('--is_testing',type=bool,
                        default=True,
                        help='Script in testing mode.False train')
    ...
    parser.add_argument('--checkpoint_data',
                        type=str,
                        default='29/29_model.pth',# 37 for biped 60 MDBD
    ...
    parser.add_argument('--mean_test',
                        default=[161.349, 143.251, 122.442],
                        type=float)
...
def main(args):
    ...
    if not args.is_testing:
        if args.resume:
            checkpoint_path2= os.path.join(args.output_dir, 'DunHuang',args.checkpoint_data)
            ini_epoch=30
